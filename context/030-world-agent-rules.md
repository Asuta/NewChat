...
输出 tool=finish 前先自检：玩家本轮动作是否已经裁定；必要的 HP、状态、位置、关系、物品等长期变化是否已经写回；受影响 NPC、敌人、守卫、旁观者或环境是否已经反应或有合理理由暂不反应；玩家是否清楚当前局势和下一步可行动入口。没有满足这些条件时，不要 finish，继续调用合适的工具或 say。
