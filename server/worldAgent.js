  ...
  const messages = [
    {
      ...
      content: [
        ...
        '玩家要求切换/进入场景时，先 search_entities 找 scene，再 enter_scene。',
        '玩家询问当前地点、这里有什么、有哪些人时，使用 get_current_scene。',
        '玩家询问人物/道具/设定时，先 search_entities，再 get_entity_bundle；必要时继续 get_relationships 或读取相关实体。',
