...
export function seedSevenDayCrownWorld(api) {
  ...
  const components = [
    ...
    ['character_rowan', 'stats', { maxHitPoints: 14, currentHitPoints: 14 }],
    ...
    ['character_milo', 'stats', { maxHitPoints: 10, currentHitPoints: 10 }],
    ...
    ['character_aldric', 'stats', { maxHitPoints: 30, currentHitPoints: 30 }],
    ...
    ['character_eve', 'stats', { maxHitPoints: 18, currentHitPoints: 18 }],
    ...
    ['character_kaen', 'stats', { maxHitPoints: 20, currentHitPoints: 20 }],
    ...
    ['character_crown_will', 'stats', { maxHitPoints: 36, currentHitPoints: 36 }],
