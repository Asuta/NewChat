...
export const SEVEN_DAY_CROWN_CHARACTER_HIT_POINTS = Object.freeze({
  character_elena: 22,
  character_rowan: 14,
  character_milo: 10,
  character_aldric: 30,
...
export function getSevenDayCrownCharacterHitPointStats(entityId) {
  const maxHitPoints = SEVEN_DAY_CROWN_CHARACTER_HIT_POINTS[entityId];
  if (!Number.isFinite(maxHitPoints)) {
    throw new Error(`Unknown Seven Day Crown character: ${entityId}`);
  }
...
export function getSevenDayCrownElenaStats() {
  return {
    ...
    proficiencyBonus: 2,
    armorClass: 16,
    ...getSevenDayCrownCharacterHitPointStats('character_elena'),
    speed: 30,
    initiativeBonus: 1,
...
export function getSevenDayCrownHollowKnightStats() {
  return {
    ...
    proficiencyBonus: 2,
    armorClass: 15,
    ...getSevenDayCrownCharacterHitPointStats('character_hollow_knight'),
    speed: 25,
    initiativeBonus: 0,
    passivePerception: 9,
  };
...
export function seedSevenDayCrownWorld(api) {
  ...
  const components = [
    ...
    ['character_rowan', 'stats', getSevenDayCrownCharacterHitPointStats('character_rowan')],
    ...
    ['character_milo', 'stats', getSevenDayCrownCharacterHitPointStats('character_milo')],
    ...
    ['character_aldric', 'stats', getSevenDayCrownCharacterHitPointStats('character_aldric')],
    ...
    ['character_eve', 'stats', getSevenDayCrownCharacterHitPointStats('character_eve')],
    ...
    ['character_kaen', 'stats', getSevenDayCrownCharacterHitPointStats('character_kaen')],
    ...
    ['character_crown_will', 'stats', getSevenDayCrownCharacterHitPointStats('character_crown_will')],
